...
hello_aphrodite::hello_aphrodite() : aph::BaseApp("base_texture")
{
}
...
void hello_aphrodite::init()
{
    ...
    aph::EventManager::GetInstance().registerEventHandler<aph::KeyboardEvent>([this](const aph::KeyboardEvent& e) {
    ...
    // setup cube
    {
        ...
        m_mvp.proj = glm::perspective(
            glm::radians(90.0f), static_cast<float>(m_options.windowWidth) / static_cast<float>(m_options.windowHeight),
            0.1f, 100.0f);
