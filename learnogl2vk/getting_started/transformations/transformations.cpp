...
private:
    ...
    void createGraphicsPipeline()
    {
        ...
        {
            auto vertShaderCode = vkl::utils::loadSpvFromFile(glslShaderDir / "getting_started/transformations/shader.vert.spv");
            auto fragShaderCode = vkl::utils::loadSpvFromFile(glslShaderDir / "getting_started/transformations/shader.frag.spv");
