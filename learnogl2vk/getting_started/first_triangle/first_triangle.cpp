...
private:
    ...
    void createGraphicsPipeline()
    {
        ...
        {
            auto vertShaderCode = vkl::utils::loadSpvFile(glslShaderDir / "getting_started/first_triangle/shader.vert.spv");
            auto fragShaderCode = vkl::utils::loadSpvFile(glslShaderDir / "getting_started/first_triangle/shader.frag.spv");
