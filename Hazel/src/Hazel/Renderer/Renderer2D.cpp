...
namespace Hazel {
    ...
    void Renderer2D::Init() {
        ...
        s_Data.QuadVertexBuffer = VertexBuffer::Create(Hazel::Renderer2DData::MaxVertices * sizeof(QuadVertex));
        ...
        Ref<IndexBuffer> quadIB = IndexBuffer::Create(quadIndices, Hazel::Renderer2DData::MaxIndices);
        ...
        s_Data.TextureShader->SetIntArray("u_Textures", samplers, Hazel::Renderer2DData::MaxTextureSlots);
