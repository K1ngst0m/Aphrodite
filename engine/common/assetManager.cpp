...
std::filesystem::path AssetManager::GetAssertDir() { return assetDir; }
std::filesystem::path AssetManager::GetShaderDir(ShaderAssetType type)
{
    switch(type)
    {
    case ShaderAssetType::GLSL: return glslShaderDir;
    case ShaderAssetType::HLSL: assert("shader not implemented."); return glslShaderDir;
    }
    return glslShaderDir;
}
std::filesystem::path AssetManager::GetTextureDir() { return textureDir; }
std::filesystem::path AssetManager::GetModelDir() { return modelDir; }
std::filesystem::path AssetManager::GetFontDir() { return fontDir; }
}  // namespace aph
