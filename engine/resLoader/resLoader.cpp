...
ResourceLoader::ResourceLoader(const ResourceLoaderCreateInfo& createInfo) : m_createInfo(createInfo)
{
}

void ResourceLoader::loadImages(const ImageLoadInfo& info)
{
...
void ResourceLoader::loadBuffers(const BufferLoadInfo& info)
{
}
}  // namespace aph
