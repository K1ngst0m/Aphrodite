...
TEST_CASE("Single Event Push and Process")
{
    ...
    manager.registerEventHandler<TestEvent>(
        [&handlerCalled](const TestEvent& event)
        {
...
TEST_CASE("Multiple Event Push and Process")
{
    ...
    manager.registerEventHandler<TestEvent>(
        [&handlerCallCount](const TestEvent& event)
        {
            handlerCallCount++;
            return true;
        });
...
TEST_CASE("Mouse Button Event Push and Process")
{
    ...
    bool handlerCalled = false;
    manager.registerEventHandler<MouseButtonEvent>(
        [&handlerCalled](const MouseButtonEvent& event)
        {
...
TEST_CASE("Mouse Move Event Push and Process")
{
    ...
    bool handlerCalled = false;
    manager.registerEventHandler<MouseMoveEvent>(
        [&handlerCalled](const MouseMoveEvent& event)
        {
...
TEST_CASE("Keyboard Event Push and Process")
{
    ...
    bool handlerCalled = false;
    manager.registerEventHandler<KeyboardEvent>(
        [&handlerCalled](const KeyboardEvent& event)
        {
...
TEST_CASE("Window Resize Event Push and Process")
{
    ...
    bool handlerCalled = false;
    manager.registerEventHandler<WindowResizeEvent>(
        [&handlerCalled](const WindowResizeEvent& event)
        {
...
TEST_CASE("Multi-Threaded Event Push with Different Event Types")
{
    ...
    manager.registerEventHandler<KeyboardEvent>(
        [&handlerCallCount](const KeyboardEvent&)
        {
            handlerCallCount++;
            return true;
        });
    manager.registerEventHandler<MouseMoveEvent>(
        [&handlerCallCount](const MouseMoveEvent&)
        {
            handlerCallCount++;
            return true;
        });
