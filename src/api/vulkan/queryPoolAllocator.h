...
struct QueryPoolAllocationConfig
{
    ...
    PipelineStatisticsFlags pipelineStatisticsFlags = PipelineStatistic::InputAssemblyVertices |
...
private:
    auto allocateQueryPools(QueryType type, uint32_t queryCount, uint32_t poolCount,
