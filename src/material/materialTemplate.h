...
// TODO @material: Create Material class that uses this template to instantiate actual materials
...
public:
    ...
    // Getters - most frequently used
    [[nodiscard]] auto getName() const -> std::string_view;
    [[nodiscard]] auto getDomain() const -> MaterialDomain;
    [[nodiscard]] auto getFeatureFlags() const -> MaterialFeatureFlags;
    [[nodiscard]] auto getParameterLayout() const -> const SmallVector<MaterialParameterDesc>&;

    // Setters - less frequently used
    void addParameter(MaterialParameterDesc parameter);
