...
public:
     ...
     */
    explicit Material(MaterialTemplate* pTemplate);
    ~Material();
     ...
     */
    [[nodiscard]] auto getTemplate() const -> MaterialTemplate*;
    ...
    /**
     * @brief Update GPU resources with current parameter values
     * @return Result indicating success or error
     */
    auto updateGPUResources() -> Result;
...
private:
    MaterialTemplate* m_pTemplate{ nullptr };
